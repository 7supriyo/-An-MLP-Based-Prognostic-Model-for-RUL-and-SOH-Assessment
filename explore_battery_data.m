% =========================================================================
% PART 1: IN-DEPTH DATA EXPLORATION & VISUALIZATION (Fully Corrected Version)
% =========================================================================
% This version fixes the bugs in the SOH and Internal Resistance calculations
% and improves the discharge curve visualization.

clear; close all; clc;

%% --- Step 1: Load the Dataset and Consolidate Data ---
...
for i = 1:numel(cell_names)
    ...
    for j = 1:numel(cycle_names)
        ...
        try
            ...
            % FIX 1: Calculate capacity using the absolute value of the negative charge.
            ...
            % FIX 2: Use current in Amperes (0.040 A) instead of Milliamps (40 mA)
            % to get the resistance in correct Ohms (Ω).
...
%% --- Visualization 1: SOH (Capacity) Fade ---
disp('Generating Plot 1: SOH Fade...');
figure('Name', 'SOH Fade Across All Cells', 'Position', [100, 100, 800, 600]);
hold on;
for i = 1:numel(cell_names)
    plot(all_cells_data{i}.cycle_numbers, all_cells_data{i}.soh_values * 100, ...
        'o-', 'Color', colors(i,:), 'LineWidth', 1.5, 'DisplayName', ['Cell ' num2str(i)]);
end
hold off;
grid on;
...
%% --- Visualization 2: Evolution of Discharge Curves ---
disp('Generating Plot 2: Discharge Curve Evolution...');
figure('Name', 'Discharge Curve Evolution', 'Position', [150, 150, 800, 600]);
cell_to_plot = 'Cell5'; 
...
for i = 1:length(cycles_to_plot)
    ...
    % FIX 3 (Optional but recommended): Plot the absolute value of capacity for intuitive visualization.
    plot(abs(q), v, 'LineWidth', 2, 'DisplayName', ['Cycle ' cycle_id(4:end)]);
end
hold off;
grid on;
...
%% --- Visualization 3: Internal Resistance Increase ---
disp('Generating Plot 3: Internal Resistance Increase...');
figure('Name', 'Internal Resistance Increase', 'Position', [200, 200, 800, 600]);
hold on;
for i = 1:numel(cell_names)
    plot(all_cells_data{i}.cycle_numbers, all_cells_data{i}.ir_values, ...
        's--', 'Color', colors(i,:), 'LineWidth', 1.5, 'DisplayName', ['Cell ' num2str(i)]);
end
hold off;
grid on;
